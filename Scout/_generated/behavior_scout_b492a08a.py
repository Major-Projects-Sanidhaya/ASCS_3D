...
class Scout_scout_b492a08a_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_b492a08a in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.727 w_wp=2.246
                 max_speed=4.36 bias=[0.0907, 0.6751]
    """
...
def create():
    return Scout_scout_b492a08a_Behavior
