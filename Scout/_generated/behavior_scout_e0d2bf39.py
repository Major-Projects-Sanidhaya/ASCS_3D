...
class Scout_scout_e0d2bf39_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_e0d2bf39 in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.879 w_wp=2.758
                 max_speed=5.45 bias=[-0.075, -0.4911]
    """
...
def create():
    return Scout_scout_e0d2bf39_Behavior
