...
class Scout_scout_60c06d4d_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_60c06d4d in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.121 w_wp=2.683
                 max_speed=4.70 bias=[0.0325, 0.6968]
    """
...
def create():
    return Scout_scout_60c06d4d_Behavior
