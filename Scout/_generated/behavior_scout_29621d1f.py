...
class Scout_scout_29621d1f_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_29621d1f in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.779 w_wp=2.395
                 max_speed=5.36 bias=[-0.6203, -0.0402]
    """
...
def create():
    return Scout_scout_29621d1f_Behavior
