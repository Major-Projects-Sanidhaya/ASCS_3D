...
class Scout_scout_9cf6f811_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_9cf6f811 in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.142 w_wp=2.742
                 max_speed=4.73 bias=[-0.7799, -0.012]
    """
...
def create():
    return Scout_scout_9cf6f811_Behavior
