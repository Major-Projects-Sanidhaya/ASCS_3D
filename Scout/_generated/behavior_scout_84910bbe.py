...
class Scout_scout_84910bbe_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_84910bbe in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.781 w_wp=2.355
                 max_speed=4.40 bias=[0.4522, -0.0957]
    """
...
def create():
    return Scout_scout_84910bbe_Behavior
