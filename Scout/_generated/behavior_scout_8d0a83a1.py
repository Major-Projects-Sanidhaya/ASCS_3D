...
class Scout_scout_8d0a83a1_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_8d0a83a1 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.727 w_wp=2.206
                 max_speed=4.57 bias=[0.1482, -0.783]
    """
...
def create():
    return Scout_scout_8d0a83a1_Behavior
