...
class Scout_scout_3f22d61a_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_3f22d61a in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.024 w_wp=2.859
                 max_speed=4.22 bias=[0.7056, -0.0077]
    """
    ...
    W_SEP        = 1.0235
    W_WP         = 2.8594
    EXPLORE_BIAS = np.array([0.7056, -0.0077])
...
def create():
    return Scout_scout_3f22d61a_Behavior
