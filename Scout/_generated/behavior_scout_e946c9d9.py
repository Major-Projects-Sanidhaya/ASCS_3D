...
class Scout_scout_e946c9d9_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_e946c9d9 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.931 w_wp=2.925
                 max_speed=4.50 bias=[0.001, -0.44]
    """
...
def create():
    return Scout_scout_e946c9d9_Behavior
