...
class Scout_scout_a211a5d6_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_a211a5d6 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.995 w_wp=2.242
                 max_speed=4.37 bias=[0.0851, -0.5459]
    """
...
def create():
    return Scout_scout_a211a5d6_Behavior
