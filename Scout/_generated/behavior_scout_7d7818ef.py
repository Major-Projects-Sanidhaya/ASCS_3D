...
class Scout_scout_7d7818ef_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_7d7818ef in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.957 w_wp=2.800
                 max_speed=5.95 bias=[-0.5269, -0.1144]
    """
...
def create():
    return Scout_scout_7d7818ef_Behavior
