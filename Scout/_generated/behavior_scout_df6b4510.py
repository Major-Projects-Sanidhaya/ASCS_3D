...
class Scout_scout_df6b4510_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_df6b4510 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.847 w_wp=2.765
                 max_speed=4.69 bias=[-0.1588, -0.6396]
    """
...
def create():
    return Scout_scout_df6b4510_Behavior
