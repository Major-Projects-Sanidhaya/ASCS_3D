...
class Scout_scout_eed273a4_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_eed273a4 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.922 w_wp=2.683
                 max_speed=5.82 bias=[-0.5311, -0.1245]
    """
...
def create():
    return Scout_scout_eed273a4_Behavior
