...
class Scout_scout_07a7f516_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_07a7f516 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.948 w_wp=2.625
                 max_speed=4.33 bias=[-0.0249, -0.601]
    """
...
def create():
    return Scout_scout_07a7f516_Behavior
