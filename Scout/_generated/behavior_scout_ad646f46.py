...
class Scout_scout_ad646f46_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_ad646f46 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.974 w_wp=2.661
                 max_speed=5.43 bias=[-0.7404, 0.1904]
    """
...
def create():
    return Scout_scout_ad646f46_Behavior
