...
class Scout_scout_3c0b6692_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_3c0b6692 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.734 w_wp=2.016
                 max_speed=5.46 bias=[0.5959, 0.1196]
    """
    ...
    W_SEP        = 0.7336
    W_WP         = 2.0162
    EXPLORE_BIAS = np.array([0.5959, 0.1196])
...
def create():
    return Scout_scout_3c0b6692_Behavior
