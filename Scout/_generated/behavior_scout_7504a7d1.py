...
class Scout_scout_7504a7d1_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_7504a7d1 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.155 w_wp=2.274
                 max_speed=4.78 bias=[0.8248, -0.0262]
    """
...
def create():
    return Scout_scout_7504a7d1_Behavior
