...
class Scout_scout_cc71b9fa_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_cc71b9fa in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.173 w_wp=2.114
                 max_speed=4.74 bias=[0.0824, 0.8229]
    """
...
def create():
    return Scout_scout_cc71b9fa_Behavior
