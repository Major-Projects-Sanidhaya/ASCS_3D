...
class Scout_scout_2cd1c2fc_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_2cd1c2fc in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.145 w_wp=2.698
                 max_speed=4.48 bias=[0.1035, -0.4029]
    """
...
def create():
    return Scout_scout_2cd1c2fc_Behavior
