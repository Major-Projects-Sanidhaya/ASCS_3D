...
class Scout_scout_3ccf7e3a_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_3ccf7e3a in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.737 w_wp=2.525
                 max_speed=4.13 bias=[-0.1203, 0.4399]
    """
...
def create():
    return Scout_scout_3ccf7e3a_Behavior
