...
class Scout_scout_9a6c8e3c_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_9a6c8e3c in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.042 w_wp=2.071
                 max_speed=5.07 bias=[0.7893, 0.0155]
    """
...
def create():
    return Scout_scout_9a6c8e3c_Behavior
