...
class Scout_scout_f33abac2_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_f33abac2 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.179 w_wp=2.290
                 max_speed=4.51 bias=[-0.0373, 0.8776]
    """
...
def create():
    return Scout_scout_f33abac2_Behavior
