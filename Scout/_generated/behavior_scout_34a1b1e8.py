...
class Scout_scout_34a1b1e8_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_34a1b1e8 in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.789 w_wp=2.725
                 max_speed=4.57 bias=[-0.5658, -0.0514]
    """
...
def create():
    return Scout_scout_34a1b1e8_Behavior
