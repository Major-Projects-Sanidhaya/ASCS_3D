...
class Scout_scout_0fe1ace7_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_0fe1ace7 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.757 w_wp=2.126
                 max_speed=5.27 bias=[-0.5448, -0.1553]
    """
...
def create():
    return Scout_scout_0fe1ace7_Behavior
