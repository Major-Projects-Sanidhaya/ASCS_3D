...
class Scout_scout_bf02df72_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_bf02df72 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.810 w_wp=2.652
                 max_speed=4.76 bias=[-0.7865, 0.1462]
    """
...
def create():
    return Scout_scout_bf02df72_Behavior
