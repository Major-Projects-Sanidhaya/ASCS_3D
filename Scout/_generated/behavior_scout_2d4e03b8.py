...
class Scout_scout_2d4e03b8_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_2d4e03b8 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.827 w_wp=2.859
                 max_speed=5.16 bias=[-0.8094, 0.0696]
    """
...
def create():
    return Scout_scout_2d4e03b8_Behavior
