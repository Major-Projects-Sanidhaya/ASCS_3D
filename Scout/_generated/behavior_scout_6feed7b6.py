...
class Scout_scout_6feed7b6_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_6feed7b6 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.997 w_wp=2.956
                 max_speed=5.21 bias=[-0.8396, -0.15]
    """
...
def create():
    return Scout_scout_6feed7b6_Behavior
