...
class Scout_scout_f723bfdf_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_f723bfdf in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.036 w_wp=2.250
                 max_speed=4.88 bias=[-0.0765, 0.7323]
    """
...
def create():
    return Scout_scout_f723bfdf_Behavior
