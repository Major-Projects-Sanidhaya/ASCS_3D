...
class Scout_scout_b8a5f29c_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_b8a5f29c in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.196 w_wp=2.528
                 max_speed=4.18 bias=[-0.1089, -0.6683]
    """
...
def create():
    return Scout_scout_b8a5f29c_Behavior
