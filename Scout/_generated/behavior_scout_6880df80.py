...
class Scout_scout_6880df80_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_6880df80 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.080 w_wp=2.136
                 max_speed=5.82 bias=[-0.0657, 0.7137]
    """
...
def create():
    return Scout_scout_6880df80_Behavior
