...
class Scout_scout_9f518e4b_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_9f518e4b in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.751 w_wp=2.747
                 max_speed=5.41 bias=[0.1349, -0.8727]
    """
...
def create():
    return Scout_scout_9f518e4b_Behavior
