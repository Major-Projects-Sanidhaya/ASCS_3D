...
class Scout_scout_fdc17f61_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_fdc17f61 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.782 w_wp=2.594
                 max_speed=4.06 bias=[0.8778, 0.0672]
    """
...
def create():
    return Scout_scout_fdc17f61_Behavior
