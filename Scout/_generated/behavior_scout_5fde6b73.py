...
class Scout_scout_5fde6b73_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_5fde6b73 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.749 w_wp=2.261
                 max_speed=4.52 bias=[0.4948, -0.1182]
    """
...
def create():
    return Scout_scout_5fde6b73_Behavior
