...
class Scout_scout_c5b4550d_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_c5b4550d in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.920 w_wp=2.056
                 max_speed=5.84 bias=[-0.882, 0.0266]
    """
...
def create():
    return Scout_scout_c5b4550d_Behavior
