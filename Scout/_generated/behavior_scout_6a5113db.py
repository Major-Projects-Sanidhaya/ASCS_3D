...
class Scout_scout_6a5113db_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_6a5113db in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.072 w_wp=2.053
                 max_speed=5.87 bias=[0.0119, 0.6589]
    """
...
def create():
    return Scout_scout_6a5113db_Behavior
