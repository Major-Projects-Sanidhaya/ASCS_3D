...
class Scout_scout_4b5a7f31_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_4b5a7f31 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.059 w_wp=2.325
                 max_speed=5.22 bias=[-0.0846, -0.8894]
    """
...
def create():
    return Scout_scout_4b5a7f31_Behavior
