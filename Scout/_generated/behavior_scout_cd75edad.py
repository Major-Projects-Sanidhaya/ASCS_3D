...
class Scout_scout_cd75edad_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_cd75edad in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.966 w_wp=2.640
                 max_speed=5.57 bias=[0.855, -0.2294]
    """
...
def create():
    return Scout_scout_cd75edad_Behavior
