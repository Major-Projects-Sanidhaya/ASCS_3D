...
class Scout_scout_0019a7d7_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_0019a7d7 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.867 w_wp=2.281
                 max_speed=4.34 bias=[0.5493, -0.0692]
    """
...
def create():
    return Scout_scout_0019a7d7_Behavior
