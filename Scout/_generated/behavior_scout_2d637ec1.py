...
class Scout_scout_2d637ec1_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_2d637ec1 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.168 w_wp=2.572
                 max_speed=4.16 bias=[-0.0962, -0.7389]
    """
...
def create():
    return Scout_scout_2d637ec1_Behavior
