...
class Scout_scout_39f2cc2c_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_39f2cc2c in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.707 w_wp=2.194
                 max_speed=4.21 bias=[-0.4998, 0.1434]
    """
...
def create():
    return Scout_scout_39f2cc2c_Behavior
