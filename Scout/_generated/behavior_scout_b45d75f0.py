...
class Scout_scout_b45d75f0_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_b45d75f0 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.109 w_wp=2.684
                 max_speed=4.58 bias=[-0.4875, 0.1355]
    """
...
def create():
    return Scout_scout_b45d75f0_Behavior
