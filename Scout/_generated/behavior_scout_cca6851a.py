...
class Scout_scout_cca6851a_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_cca6851a in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.880 w_wp=2.655
                 max_speed=5.37 bias=[-0.696, 0.1895]
    """
...
def create():
    return Scout_scout_cca6851a_Behavior
