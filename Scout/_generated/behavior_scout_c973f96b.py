...
class Scout_scout_c973f96b_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_c973f96b in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.914 w_wp=2.148
                 max_speed=5.72 bias=[0.8167, 0.1591]
    """
...
def create():
    return Scout_scout_c973f96b_Behavior
