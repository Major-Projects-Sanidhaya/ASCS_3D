...
class Scout_scout_daabd7df_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_daabd7df in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.838 w_wp=2.739
                 max_speed=5.65 bias=[-0.7088, -0.2053]
    """
...
def create():
    return Scout_scout_daabd7df_Behavior
