...
class Scout_scout_c3daf3a5_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_c3daf3a5 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.759 w_wp=2.560
                 max_speed=4.57 bias=[-0.8441, -0.14]
    """
...
def create():
    return Scout_scout_c3daf3a5_Behavior
