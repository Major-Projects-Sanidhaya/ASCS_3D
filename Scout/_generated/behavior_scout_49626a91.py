...
class Scout_scout_49626a91_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_49626a91 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.723 w_wp=2.564
                 max_speed=4.20 bias=[-0.1382, -0.5732]
    """
...
def create():
    return Scout_scout_49626a91_Behavior
