...
class Scout_scout_06422bd7_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_06422bd7 in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.130 w_wp=2.056
                 max_speed=5.00 bias=[-0.8525, -0.2502]
    """
...
def create():
    return Scout_scout_06422bd7_Behavior
