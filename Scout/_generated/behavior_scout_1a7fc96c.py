...
class Scout_scout_1a7fc96c_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_1a7fc96c in zone 2.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.109 w_wp=2.121
                 max_speed=5.05 bias=[0.0909, -0.4239]
    """
...
def create():
    return Scout_scout_1a7fc96c_Behavior
