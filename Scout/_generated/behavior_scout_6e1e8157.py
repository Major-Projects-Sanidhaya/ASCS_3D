...
class Scout_scout_6e1e8157_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_6e1e8157 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.178 w_wp=2.349
                 max_speed=4.19 bias=[0.638, 0.1853]
    """
...
def create():
    return Scout_scout_6e1e8157_Behavior
