...
class Scout_scout_1b8b0c55_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_1b8b0c55 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.049 w_wp=2.173
                 max_speed=5.29 bias=[-0.1228, 0.4779]
    """
...
def create():
    return Scout_scout_1b8b0c55_Behavior
