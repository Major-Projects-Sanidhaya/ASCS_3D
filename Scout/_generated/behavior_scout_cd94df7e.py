...
class Scout_scout_cd94df7e_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_cd94df7e in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.999 w_wp=2.948
                 max_speed=5.82 bias=[-0.0442, 0.6172]
    """
...
def create():
    return Scout_scout_cd94df7e_Behavior
