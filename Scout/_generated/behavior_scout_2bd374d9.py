...
class Scout_scout_2bd374d9_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_2bd374d9 in zone 1.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=0.744 w_wp=2.771
                 max_speed=5.57 bias=[0.6895, 0.1533]
    """
...
def create():
    return Scout_scout_2bd374d9_Behavior
