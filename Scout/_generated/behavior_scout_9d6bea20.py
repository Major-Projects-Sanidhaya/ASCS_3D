...
class Scout_scout_9d6bea20_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_9d6bea20 in zone 0.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.191 w_wp=2.602
                 max_speed=5.78 bias=[0.6344, -0.0942]
    """
...
def create():
    return Scout_scout_9d6bea20_Behavior
