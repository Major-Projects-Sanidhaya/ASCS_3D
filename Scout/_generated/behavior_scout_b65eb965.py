...
class Scout_scout_b65eb965_Behavior(ScoutBehavior):
    """
    Auto-generated behavior for scout scout_b65eb965 in zone 3.
    Generated at spawn. Destroyed at deletion.
    Personality: w_sep=1.146 w_wp=2.992
                 max_speed=4.12 bias=[-0.0373, 0.7007]
    """
...
def create():
    return Scout_scout_b65eb965_Behavior
